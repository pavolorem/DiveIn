...
import com.example.divein.*

/** Entry activity to select the detection mode.  */
@Suppress("DEPRECATION")
class MainML : AppCompatActivity() {
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        findViewById<RecyclerView>(R.id.mode_recycler_view).apply {
            ...
            layoutManager = LinearLayoutManager(this@MainML)
                    ...
                    when (detectionMode) {
                        ...
                        DetectionMode.BARCODE_LIVE ->
                            activity.startActivity(
                                Intent(
                                    activity,
                                    LiveBarcodeScanningActivityAsset::class.java
                                )
                            )
