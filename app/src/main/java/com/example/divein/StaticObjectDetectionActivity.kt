...
import com.example.divein.productsearch.PreviewCardAdapter
import com.example.divein.productsearch.ProductAdapter
import com.example.divein.productsearch.SearchEngine
import com.google.android.material.bottomsheet.BottomSheetBehavior
import com.google.android.material.chip.Chip
import com.google.common.collect.ImmutableList
import com.google.mlkit.md.BitmapInputInfo
...
class StaticObjectDetectionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        previewCardCarousel = findViewById<RecyclerView>(R.id.card_recycler_view).apply {
            ...
            layoutManager = LinearLayoutManager(
                this@StaticObjectDetectionActivity,
    ...
    private fun detectObjects(imageUri: Uri) {
        ...
        previewCardCarousel?.adapter =
            PreviewCardAdapter(ImmutableList.of()) { showSearchResults(it) }
    ...
    private fun onSearchCompleted(detectedObject: DetectedObjectInfo, productList: List<Product>) {
        ...
        searchedObjectMap[detectedObject.objectIndex] =
            SearchedObject(resources, detectedObject, productList)
        ...
        loadingView?.visibility = View.GONE
        previewCardCarousel?.adapter =
            PreviewCardAdapter(ImmutableList.copyOf(searchedObjectMap.values)) {
                showSearchResults(
                    it
                )
            }
        ...
        for (searchedObject in searchedObjectMap.values) {
            ...
            val animatorSet = AnimatorInflater.loadAnimator(
                this,
                R.animator.static_image_dot_enter
            ) as AnimatorSet
    ...
    private fun selectNewObject(objectIndex: Int) {
        val dotViewToDeselect =
            dotViewContainer!!.getChildAt(currentSelectedObjectIndex) as StaticObjectDotView
    ...
    private class CardItemDecoration constructor(resources: Resources) :
        RecyclerView.ItemDecoration() {

        private val cardSpacing: Int =
            resources.getDimensionPixelOffset(R.dimen.preview_card_spacing)
