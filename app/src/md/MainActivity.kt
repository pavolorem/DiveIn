...
class MainActivity : AppCompatActivity() {
    ...
    private inner class ModeItemAdapter internal constructor(private val detectionModes: Array<DetectionMode>) :
        RecyclerView.Adapter<ModeItemAdapter.ModeItemViewHolder>(), android.os.Parcelable {

        constructor(parcel: android.os.Parcel) : this(TODO("detectionModes")) {
        }
        ...
        companion object CREATOR : android.os.Parcelable.Creator<ModeItemAdapter> {
            override fun createFromParcel(parcel: android.os.Parcel): ModeItemAdapter {
                return ModeItemAdapter(parcel)
            }

            override fun newArray(size: Int): Array<ModeItemAdapter?> {
