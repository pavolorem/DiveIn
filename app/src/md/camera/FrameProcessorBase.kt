...
abstract class FrameProcessorBase<T>() : FrameProcessor, android.os.Parcelable {
    ...
    companion object CREATOR : android.os.Parcelable.Creator<FrameProcessorBase> {
        override fun createFromParcel(parcel: android.os.Parcel): FrameProcessorBase {
            return FrameProcessorBase(parcel)
        }

        override fun newArray(size: Int): Array<FrameProcessorBase?> {
